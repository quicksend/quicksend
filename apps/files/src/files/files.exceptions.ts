...
export class FilesException extends RpcException {}
...
export class FileIncapableException extends FilesException {
  constructor(capability: FileCapabilities) {
    super(FileIncapableException.mapToExceptionMessage(capability));
  }

  private static mapToExceptionMessage(capability: FileCapabilities): string {
    const name = FileCapabilities[capability] as keyof typeof FileCapabilities;
